      ...
      try {
        ...
        if (res.status === 200 && res.data.success === true) {
          ...
          setFormData({
            ...
            per_hour_rate:
              data.per_hour_rate != null ? String(data.per_hour_rate) : "",
            total_hours:
              data.total_hours != null ? String(data.total_hours) : "",
            weekly_fixed_rate:
              data.weekly_fixed_rate != null
                ? String(data.weekly_fixed_rate)
                : "",
            total_days: data.total_days != null ? String(data.total_days) : "",
    ...
    <div>
      ...
      <div className="mx-auto bg-white rounded-lg shadow px-[30px] py-[30px] md:px-[40px] md:py-[40px] mt-[20px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px] mb-[40px]">
          ...
          <div className="flex flex-col gap-1">
            <Input
              label="Carry Forward Admin VAT Percentage"
              type="number"
          ...
          <div className="flex flex-col gap-1">
            <Input
              label="Carry Forward Vehicle VAT Percentage"
              type="number"
          ...
          <div className="flex flex-col gap-1">
            <Input
              label="Carry Forward Insurance VAT Percentage"
              type="number"
          ...
          <div className="flex flex-col gap-1">
            <Input
              label="Carry Forward Fuel VAT Percentage"
              type="number"
