...
import { addJob, deleteJob, getAllJobs, getJob, updateJob , importJobs , deleteBulkJobs , getDriverJobs , exportJobs } from "../controllers/jobController.js";
...
router.post("/export-jobs" , verifyToken, exportJobs);
